...
## Extracting model details {#Extracting-model-details}
...
## Generating and running scenarios {#Generating-and-running-scenarios}
...
## Intervention location selection {#Intervention-location-selection}
...
## Intervention location selection - summary functions {#Intervention-location-selection-summary-functions}
...
![](../assets/imgs/analysis/taxonomy.png)


## Scenarios coloured by cluster {#Scenarios-coloured-by-cluster}
...
![](../assets/imgs/analysis/scenarios_by_cluster.png)
...
![](../assets/imgs/analysis/connectivity.png)


## Selection frequency by intervention type {#Selection-frequency-by-intervention-type}
...
![](../assets/imgs/analysis/ranks_by_intervention.png)


## DHW scenario {#DHW-scenario}
...
![](../assets/imgs/analysis/dhw_scenario.png)


## DHW scenarios (all) {#DHW-scenarios-all}
...
![](../assets/imgs/analysis/dhw_scenarios.png)


## Cyclone scenario {#Cyclone-scenario}
...
![](../assets/imgs/analysis/cyclone_scenario.png)
