...
@testset "temporal.jl" begin
    ...
    @testset "scenario_total_cover" begin
        ...
        test_absolute_metric(metrics.scenario_total_cover, (tac,))
        test_absolute_metric(metrics.scenario_total_cover, (TEST_RS,))
    ...
    @testset "scenario_relative_cover" begin
        test_absolute_metric(metrics.scenario_relative_cover, (TEST_RS,))
    end

    @testset "scenario_relative_juveniles" begin
        test_absolute_metric(metrics.scenario_relative_juveniles, (TEST_RS,))
    ...
    @testset "scenario_absolute_juveniles" begin
        test_absolute_metric(metrics.scenario_absolute_juveniles, (TEST_RS,))
        _coral_spec = ADRIA.to_coral_spec(TEST_SCENS[1, :])
    ...
    @testset "scenario_juvenile_indicator" begin
        test_absolute_metric(metrics.scenario_juvenile_indicator, (TEST_RS,))
        _coral_spec = ADRIA.to_coral_spec(TEST_SCENS[1, :])
    ...
    @testset "scenario_asv" begin
        test_absolute_metric(metrics.scenario_asv, (TEST_RS,))
    ...
    @testset "scenario_rsv" begin
        test_absolute_metric(metrics.scenario_rsv, (TEST_RS,))
        ...
        #     )
        #     test_absolute_metric(metrics.scenario_rsv, (rsv,))
        # end
    end

    @testset "scenario_evenness" begin
        test_absolute_metric(metrics.scenario_evenness, (TEST_RS,))
        ...
        #     test_absolute_metric(metrics.scenario_evenness, (ce,))
        # end
    end
