...
@testset "Location selection" begin
    ...
    @testset "Select under-represented cluster" begin
        ...
        @test diversity_scores[n_locs-1] > diversity_scores[1] || "Underrepresented cluster was not assigned a higher score"
        @test diversity_scores[n_locs-2] > diversity_scores[1] || "Underrepresented cluster was not assigned a higher score"
        @test diversity_scores[n_c1+2] > diversity_scores[n_c1-1] || "Underrepresented cluster was not assigned a higher score"
        ...
        @test "reef_$(lpad(n_c1+2, 2, "0"))" ∈ result || "Under-represented cluster 2 not selected!"
        @test "reef_$(lpad(n_locs-2, 2, "0"))" ∈ result  || "Under-represented cluster 3 not selected!"
    end
