...
# ### 2. Run Simulations
#
# Run the scenarios normally. Ensure you are using a domain compatible with the Great Barrier
# Reef (GBR) if you intend to use the standard CREAM cost models.
