...
function run_model(
    ...
    c_mean_reference::Array{Float64,3} = zeros(n_groups, n_locs, a_adapt_delay)
    Assume heat tolerance enhancement is based on population from `a_adapt_delay` years ago
    a_adapt_delay::Int64 = 5
    # c_mean_t
