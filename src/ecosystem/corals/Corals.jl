...
function bin_edges()
    return Matrix([
        0.0 5.0 7.5 10.0 15.0 20.0 40.0 100.0 150.0;
        0.0 5.0 7.5 10.0 15.0 20.0 35.0 50.0 100.0;
        0.0 5.0 7.5 10.0 12.0 15.0 20.0 40.0 50.0;
        0.0 5.0 7.5 10.0 15.0 20.0 40.0 50.0 100.0;
        0.0 5.0 7.5 10.0 15.0 20.0 40.0 50.0 100.0
    ])
end
...
function coral_spec()::NamedTuple
    ...
    linear_extension::Matrix{Float64} = [
        0.609456 1.07184 2.55149 2.55149 5.07988 9.45091 16.8505 0.0;
        0.768556 1.22085 1.86447 1.86447 2.82297 3.52938 3.00422 0.0;
        0.190455 0.343747 0.615467 0.615467 0.97477 1.70079 2.91729 0.0;
        0.318034 0.47385 0.683729 0.683729 0.710587 0.581085 0.581085 0.0;
        0.122478 0.217702 0.382098 0.382098 0.718781 1.24172 2.08546 0.0
    ]
    ...
    # ]
    survival_rate::Matrix{Float64} = [
        0.6 0.76 0.805 0.76 0.76 0.85 0.86 0.86;                            # Tabular Acropora
        0.6 0.76 0.77 0.875 0.875 0.83 0.90 0.90;                            # Corymbose Acropora
        0.52 0.77 0.77 0.875 0.875 0.89 0.97621179 0.97621179;                # Corymbose non-Acropora
        0.72 0.87 0.77 0.98 0.98 0.996931548 0.996931548 0.996931548;        # Small massives and encrusting
        0.58 0.87 0.78 0.983568572 0.983568572 0.984667677 0.984667677 0.984667677  # Large massives
    ]
