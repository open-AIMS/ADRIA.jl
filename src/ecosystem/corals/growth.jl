...
"""
    truncated_normal_mean(normal_mean::Float64, normal_stdev::Float64,
        lower_bound::Float64, upper_bound::Float64)::Float64

Calculates the mean of a truncated normal distribution given the mean and standard deviation
