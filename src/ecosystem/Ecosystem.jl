...
Base.@kwdef struct Criteria{P,N} <: EcoModel
    ...
    top_n::N = Param(10, ptype="integer", bounds=(5, 500 + 1), dists="unif") # sites in prefseedsites or prefshadesites will be replaced with sites within top_n ranked sites if not satisfying distance threshold
