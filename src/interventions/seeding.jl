...
function distribute_seeded_corals(total_site_area::Vector{Float64},
    ...
    scaled_seed_TA = prop_area_avail[prefseedsites] .* (n_to_seed.nTA * col_area_seed.areaTA)
    scaled_seed_CA = prop_area_avail[prefseedsites] .* (n_to_seed.nCA * col_area_seed.areaCA)
