Base.@kwdef struct Criteria{P,N} <: EcoModel
    wave_stress::P = Param(1.0, ptype="real", bounds=(0.8, 1.0), dists="unif",
    ...
    heat_stress::P = Param(1.0, ptype="real", bounds=(0.6, 1.0), dists="unif",
    ...
    out_seed_connectivity::P = Param(1.0, ptype="real", bounds=(0.4, 0.8), dists="unif",
    ...
    zone_seed::P = Param(0.0, ptype="real", bounds=(0.7, 1.0), dists="unif",
    ...
    coral_cover_tol::P = Param(0.2, ptype="real", bounds=(0.8, 1.0), dists="unif",
    ...
    dist_thresh::P = Param(0.1, ptype="real", bounds=(0.4, 1.0), dists="unif",
